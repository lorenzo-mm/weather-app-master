...
function AirPollution() {
  ...
  return (
    <div
      className="air-pollution pt-6 px-4 h-[12rem] border rounded-lg flex flex-col gap-8 shadow-sm backdrop-blur-sm dark:shadow-none col-span-full sm-2:col-span-2 md:col-span-2 xl:col-span-2 bg-container dark:bg-transparent"
    >
