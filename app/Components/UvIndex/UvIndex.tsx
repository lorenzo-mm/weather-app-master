...
function UvIndex() {
  ...
  return (
    <div className="pt-6 pb-5 px-4 h-[12rem] border rounded-lg flex flex-col gap-5 shadow-sm backdrop-blur-sm dark:shadow-none bg-container dark:bg-transparent">
      <div className="top">
