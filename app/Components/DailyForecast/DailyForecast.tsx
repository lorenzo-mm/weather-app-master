...
function DailyForecast() {
  ...
  return (
    <div
      className="pt-6 px-4 h-[12rem] border rounded-lg flex flex-col gap-8 shadow-sm dark:shadow-none col-span-full sm-2:col-span-2 md:col-span-2 xl:col-span-2 backdrop-blur-sm bg-container dark:bg-transparent"
    >
